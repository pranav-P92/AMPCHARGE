...
const Addstation = () => {
  ...
  const filteredStations = selectedConnectors.length > 0
    ? stations.filter(station => selectedConnectors.some(connector => 
      station.connectorsType.includes(connector)))
    : stations;
      ...
      <div className="adcontainer">
        ...
        <div className="adbox">
          <div className="header">
            <label className="headadmin"><FaUserCog size={26} /><p>Admin</p></label>
          </div>
