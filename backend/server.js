...
const mongoURI = "mongodb+srv://username:password@evcluster0.bonz0fk.mongodb.net/?retryWrites=true&w=majority&appName=EVCluster0";
...
app.post('/adminregister', async (req, res) => {
  ...
  try {
    ...
    const newAdmin = new Admin({ adminID, adminemail, adminpassword: hashedPassword });
    await newAdmin.save();
